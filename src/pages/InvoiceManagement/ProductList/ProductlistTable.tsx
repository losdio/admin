            ...
            Cell: (cell: any) => (
                        <Dropdown>
                            ...
                            <Dropdown.Menu className="dropdown-menu-end">
                                <li>
                                    <Dropdown.Item onClick={() => { /* handle view action */ }}><i className="las la-eye fs-18 align-middle me-2 text-muted"></i>
                                        View</Dropdown.Item>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Dropdown.Item onClick={() => { /* handle download action */ }}><i className="las la-file-download fs-18 align-middle me-2 text-muted"></i>
                                        Download</Dropdown.Item>
                                </li>
                                <li className="dropdown-divider"></li>
                                <li>
                                    <Dropdown.Item className="remove-item-btn" onClick={() => { const item = cell.row.original; handleDeleteModal(item); }}>
                           ...
                           <div className="d-flex gap-3">
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    ...
                                    <Dropdown.Item onClick={() => {}}>Last Week</Dropdown.Item>
                                    <Dropdown.Item onClick={() => {}}>Last Month</Dropdown.Item>
                                    <Dropdown.Item onClick={() => {}}>Last Year</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                           </div>
                        </div>
