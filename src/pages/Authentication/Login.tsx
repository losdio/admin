                                                    ...
                                                    <Card.Body className="p-lg-5 p-4">
                                                        ...
                                                        >
                                                                ...
                                                                <div className="position-relative auth-pass-inputgroup mb-3">
                                                                    ...
                                                                    <button className="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon" onClick={() => setPasswordShow(!passwordShow)} title="Show/Hide Password">
